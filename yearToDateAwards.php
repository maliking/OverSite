...
$sql = "SELECT UsersInfo.firstName, UsersInfo.lastName, COUNT(commInfo.license) as closedUnits, commInfo.license, 
        ...
        FROM UsersInfo LEFT JOIN commInfo ON UsersInfo.license = commInfo.license WHERE UsersInfo.userType != '0' AND YEAR(commInfo.settlementDate) = YEAR(CURDATE()) GROUP BY commInfo.license
