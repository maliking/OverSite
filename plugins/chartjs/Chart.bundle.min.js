  ...
  return function t(e, n, i) {
    ...
    6: [function(e, n, i) {
      ! function(e, a) {
        ...
        function y(t, e) {
          var n, i, a;
          if (s(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), s(e._i) || (t._i = e._i), s(e._f) || (t._f = e._f), s(e._l) || (t._l = e._l), s(e._strict) || (t._strict = e._strict), s(e._tzm) || (t._tzm = e._tzm), s(e._isUTC) || (t._isUTC = e._isUTC), s(e._offset) || (t._offset = e._offset), s(e._pf) || (t._pf = p(e)), s(e._locale) || (t._locale = e._locale), Mi.length > 0)
            for (n = 0; n < Mi.length; n++) i = Mi[n], a = e[i], s(a) || (t[i] = a);
          return t
        }
        ...
        function J(t) {
          ...
          for (e = 0, n = i.length; e < n; e++) Bi[i[e]] ? i[e] = Bi[i[e]] : i[e] = X(i[e]);
          return function(e) {
            var a, r = "";
        ...
        function Q(t, e) {
          ...
          var i = 5;
          for (zi.lastIndex = 0; i >= 0 && zi.test(t);) t = t.replace(zi, n), zi.lastIndex = 0, i -= 1;
          return t
        }
        ...
        function ee(t, e) {
          if (null !== e) {
            var n = Oa;
            if (e.abbr = t, null != Ra[t]) D("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), n = Ra[t]._config;
        ...
        function ce(t) {
          var e, n, i, a, r = [];
          if (!t._d) {
            for (i = de(t), t._w && null == t._a[ua] && null == t._a[la] && he(t), null != t._dayOfYear && (a = ue(t._a[sa], i[sa]), (t._dayOfYear > vt(a) || 0 === t._dayOfYear) && (p(t)._overflowDayOfYear = !0), n = _t(a, 0, t._dayOfYear), t._a[la] = n.getUTCMonth(), t._a[ua] = n.getUTCDate()), e = 0; e < 3 && null == t._a[e]; ++e) t._a[e] = r[e] = i[e];
        ...
        function he(t) {
          var e, n, i, a, r, o, s, l;
          if (e = t._w, null != e.GG || null != e.W || null != e.E) r = 1, o = 4, n = ue(e.GG, t._a[sa], Mt(_e(), 1, 4).year), i = ue(e.W, 1), a = ue(e.E, 1), (a < 1 || a > 7) && (l = !0);
          else {
        ...
        function fe(e) {
          ...
          var n, i, a, r, o, s = "" + e._i,
            l = s.length,
            u = 0;
          for (a = Q(e._f, e._locale).match(Yi) || [], n = 0; n < a.length; n++) r = a[n], i = (s.match(tt(r, e)) || [])[0], i && (o = s.substr(0, s.indexOf(i)), o.length > 0 && p(e).unusedInput.push(o), s = s.slice(s.indexOf(i) + i.length), u += i.length), Bi[r] ? (i ? p(e).empty = !1 : p(e).unusedTokens.push(r), rt(r, i, e)) : e._strict && !i && p(e).unusedTokens.push(r);
        ...
        function pe(t) {
          ...
          for (a = 0; a < t._f.length; a++) r = 0, e = y({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[a], fe(e), m(e) && (r += p(e).charsLeftOver, r += 10 * p(e).unusedTokens.length, p(e).score = r, (null == i || r < i) && (i = r, n = e));
          h(t, n || e)
        }
        ...
        function ye(t) {
          ...
          return t._locale = t._locale || ie(t._l), null === e || void 0 === n && "" === e ? v({
            nullInput: !0
          }) : ("string" == typeof e && (t._i = e = t._locale.preparse(e)), x(e) ? new b(re(e)) : (u(e) ? t._d = e : a(n) ? pe(t) : n ? fe(t) : be(t), m(t) || (t._d = null), t))
        }
        ...
        function Pe(t) {
          var e = z(t),
            ...
            u = e.second || 0,
            d = e.millisecond || 0;
          this._isValid = Se(e), this._milliseconds = +d + 1e3 * u + 6e4 * l + 1e3 * s * 60 * 60, this._days = +o + 7 * r, this._months = +a + 3 * i + 12 * n, this._data = {}, this._locale = ie(), this._bubble()
        }
        ...
        function Ge(t, e) {
          ...
          return Te(t) ? r = {
            ...
            m: qe(o[7], n),
            s: qe(o[8], n)
          }) : null == r ? r = {} : "object" == typeof r && ("from" in r || "to" in r) && (a = Xe(_e(r.from), _e(r.to)), r = {}, r.ms = a.milliseconds, r.M = a.months), i = new Pe(r), Te(t) && c(t, "_locale") && (i._locale = t._locale), i
        }
        ...
        function ln(t, e, n) {
          var i, a, r, o;
          return this.isValid() ? (i = Oe(t, this), i.isValid() ? (a = 6e4 * (i.utcOffset() - this.utcOffset()), e = Y(e), "year" === e || "month" === e || "quarter" === e ? (o = un(this, i), "quarter" === e ? o /= 3 : "year" === e && (o /= 12)) : (r = this - i, o = "second" === e ? r / 1e3 : "minute" === e ? r / 6e4 : "hour" === e ? r / 36e5 : "day" === e ? (r - a) / 864e5 : "week" === e ? (r - a) / 6048e5 : r), n ? o : _(o)) : NaN) : NaN
        }
        ...
        function oi() {
          var t, e, n, i, a, r = this._milliseconds,
            ...
            s = this._months,
            l = this._data;
          return r >= 0 && o >= 0 && s >= 0 || r <= 0 && o <= 0 && s <= 0 || (r += 864e5 * ri(li(s) + o), o = 0, s = 0), l.milliseconds = r % 1e3, t = _(r / 1e3), l.seconds = t % 60, e = _(t / 60), l.minutes = e % 60, n = _(e / 60), l.hours = n % 24, o += _(n / 24), a = _(si(o)), s += a, o -= ri(li(a)), i = _(s / 12), s %= 12, l.days = o, l.months = s, l.years = i, this
        }
        ...
        function ui(t) {
          ...
          if (t = Y(t), "month" === t || "year" === t) return e = this._days + i / 864e5, n = this._months + si(e), "month" === t ? n : n / 12;
        ...
        function xi() {
          if (!this.isValid()) return this.localeData().invalidDate();
          var t, e, n, i = Mr(this._milliseconds) / 1e3,
            a = Mr(this._days),
            r = Mr(this._months);
        ...
        t.defaults.bar = {
          ...
          draw: function() {
            var t, n = this,
              ...
              o = a.length,
              s = 0;
            for (e.canvas.clipArea(i.ctx, i.chartArea); s < o; ++s) t = r.data[s], null === t || void 0 === t || isNaN(t) || a[s].draw();
    ...
    19: [function(t, e, n) {
      ...
      e.exports = function(t) {
        ...
        t.defaults.polarArea = {
          ...
          updateElement: function(t, n, i) {
            for (var a = this, r = a.chart, o = a.getDataset(), s = r.options, l = s.animation, u = r.scale, d = e.getValueAtIndexOrDefault, c = r.data.labels, h = a.calculateCircumference(o.data[n]), f = u.xCenter, g = u.yCenter, p = 0, m = a.getMeta(), v = 0; v < n; ++v) isNaN(o.data[v]) || m.data[v].hidden || ++p;
            var y = s.startAngle,
        ...
        function e(t, e, n, a) {
          ...
          for (r = 0, o = g.length; r < o; ++r)
            if (s = g[r], d = n[s], e.hasOwnProperty(s) || (e[s] = d), l = e[s], l !== d && "_" !== s[0]) {
              if (t.hasOwnProperty(s) || (t[s] = l), u = t[s], c = typeof d, c === typeof u)
                if ("string" === c) {
        ...
        t.defaults.scale = {
          ...
          draw: function(e) {
            ...
            if (r.display) {
              ...
              var M = [];
              if (p) {
                if (o = !1, (w + d.autoSkipPadding) * a.ticks.length > a.width - (a.paddingLeft + a.paddingRight) && (o = 1 + Math.floor((w + d.autoSkipPadding) * a.ticks.length / (a.width - (a.paddingLeft + a.paddingRight)))), s && a.ticks.length > s)
              ...
              if (i.each(a.ticks, function(t, n) {
                  if (void 0 !== t && null !== t) {
                    ...
                    if ((!l || s) && void 0 !== t && null !== t) {
                      ...
                      var b, x, k, w, T, I, A, F, O, R, L = "middle",
                        V = "middle";
                      if (p) {
                ...
                var T, I, A = 0;
                if (p) T = a.left + (a.right - a.left) / 2, I = "bottom" === r.position ? a.bottom - x.size / 2 : a.top + x.size / 2;
                else {
                  var F = "left" === r.position;
                  T = F ? a.left + x.size / 2 : a.right - x.size / 2, I = a.top + (a.bottom - a.top) / 2, A = F ? -.5 * Math.PI : .5 * Math.PI
                }
        ...
        t.defaults.global.tooltips = {
          ...
          getCaretPosition: function(t, e, n) {
            var i, a, r, o, s, l, u = n.caretSize,
              ...
              p = e.width,
              m = e.height;
            if ("center" === h) s = g + m / 2, "left" === c ? (i = f, a = i - u, r = i, o = s + u, l = s - u) : (i = f + p, a = i + u, r = i, o = s - u, l = s + u);
            else if ("left" === c ? (a = f + d + u, i = a - u, r = a + u) : "right" === c ? (a = f + p - d - u, i = a - u, r = a + u) : (a = f + p / 2, i = a - u, r = a + u), "top" === h) o = g, s = o - u, l = o;
            else {
              o = g + m, s = o + u, l = o;
              var v = r;
              r = i, i = v
          ...
          drawBackground: function(t, n, i, a, r) {
            ...
            var o = n.xAlign,
              ...
              c = a.height,
              h = n.cornerRadius;
            i.beginPath(), i.moveTo(l + h, u), "top" === s && this.drawCaret(t, a), i.lineTo(l + d - h, u), i.quadraticCurveTo(l + d, u, l + d, u + h),
    ...
    41: [function(t, e, n) {
      ...
      e.exports = function(t) {
        ...
        function s(t, e, n, i, a, s) {
          var l, u, d, c, h, f, g, p = e.length,
            m = i.spanGaps,
            v = [],
            y = [],
            b = 0,
            x = 0;
          for (t.beginPath(), l = 0, u = p + !!s; l < u; ++l) d = l % p, c = e[d]._view, h = n(c, d, i), f = r(c), g = r(h), f && g ? (b = v.push(c), x = y.push(h)) : b && x && (m ? (f && v.push(c), g && y.push(h)) : (o(t, v, y, b, x), b = x = 0, v = [], y = []));
        ...
        return {
          ...
          afterDatasetsUpdate: function(r, o) {
            ...
            for (l = 0; l < c; ++l) d = f[l], d && (d.fill = i(f, l, h), d.boundary = n(d), d.mapper = a(d))
          },
          ...
          draw: function() {
            ...
            if (r.display) {
              var s, l, u, d = a(r.fontSize, o.defaultFontSize),
                ...
                v = e.bottom,
                y = e.right;
              i.fillStyle = a(r.fontColor, o.defaultFontColor), i.font = f, e.isHorizontal() ? (s = m + (y - m) / 2, l = p + (v - p) / 2, u = y - m) : (s = "left" === r.position ? m + d / 2 : y - d / 2, l = p + (v - p) / 2, u = v - p, g = Math.PI * ("left" === r.position ? -.5 : .5)), i.save(), i.translate(s, l), i.rotate(g), i.textAlign = "center", i.textBaseline = "middle", i.fillText(r.text, 0, 0, u), i.restore()
            }
          }
        }), {
          id: "title",
    ...
    48: [function(t, e, n) {
      ...
      e.exports = function(t) {
        ...
        function c(t, n, i, a) {
          var r = t.ctx;
          if (r.strokeStyle = f.getValueAtIndexOrDefault(n.color, a - 1), r.lineWidth = f.getValueAtIndexOrDefault(n.lineWidth, a - 1), t.options.gridLines.circular) r.beginPath(), r.arc(t.xCenter, t.yCenter, i, 0, 2 * Math.PI),
