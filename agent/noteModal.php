  ...
  <div class="modal-dialog" style="height:100%;">
    ...
    <div class="modal-content" style="height:95%;">
      ...
      <div class="modal-footer" style="border-top: solid 2px black">
        ...
        <?php echo '<td><button data-toggle="modal" onClick=sendNotesText(' . $favorite['bathroom'] . ')>Text Notes</button></td>'; ?>
        <button type="button" class="btn btn-default" onClick="sendNotesText()">Text Notes</button>
