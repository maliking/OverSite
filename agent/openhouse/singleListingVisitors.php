                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3>[Listing Address] Visitors</h3>
                                     <!-- search form -->
      <form action="#" method="get" class="sidebar-form-sm">
    ...
    <div class="panel panel-default">
         <div class="panel-heading row">
          ...
          <a data-toggle="collapse" href="#collapse1" class="col-md-1"><i class="more-less fa fa-plus"></i>  </a>
                <div class="col-md-3">October 3rd, 2017</div></h4>
      </div>
 ...
 <button type="button" class="btn-xs btn-danger"> Remove </button>
   ...
   <div class="col-md-6">
    ...
    <div class="panel panel-default">
         <div class="panel-heading row">
            <h4>
          <a data-toggle="collapse" href="#collapse7" class="col-md-1"><i class="more-less fa fa-plus"></i>  </a>
                <div class="col-md-3">October 7th, 2017</div></h4>
      </div>
