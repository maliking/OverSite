            ...
            <div class="row">
                <div class="col-lg-2 col-xs-6">
                    ...
                    <div class="small-box bg-blue">
                        <div class="inner">
                            <h3>
                                <?php echo number_format($result['avgPercent'], 2); ?><sup
                ...
                <div class="col-lg-2 col-xs-6">
                    ...
                    <div class="small-box bg-blue">
                        <div class="inner">
                            <h3>
                                <?php echo number_format($result['avgPercent'], 0); ?><sup
                                        style="font-size: 20px">%</sup></h3>
                            <p>Avg. Commission </p>
                        </div>
                        <div class="icon">
                                                ...
                                                <div class="box-body no-padding">
                                                    <table id="modal-table" class="table table-striped">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form action="">
                                                                    <input type="radio" name="preapproved" value="yes">
                                                                    Yes<br>
                                                                    <input type="radio" name="preapproved" value="no">
                                                                    No<br>
                                                                </form>
                            ...
                            May 19, 2017 1:09pm
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <i class="fa fa-calendar"></i>
                                                                <input type="text"
                                                                       class="fa fa-calendar form-control pull-right"
                                                                       id="datepicker">
                                                            </td>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea id="textArea" style="color:black;" rows="6"
                                                          cols="60"></textarea>
