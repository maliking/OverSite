                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th colspan="2" style="text-align: center; background-color: #D2E4E8">Property</th>
                                                <th colspan="4" style="text-align: center; background-color: #faf2cc">Important Dates</th>
                                            </tr>
                                            <tr>
                                                <th style="text-align: center"><i class="fa fa-map-marker"></i> Address</th>
                                                <th style="text-align: center"><i class="fa fa-address-card-o"></i> Owner</th>
                                                <th style="text-align: center"><i class="fa fa-check-square-o"></i> Approved</th>
                                                <th style="text-align: center"><i class="fa fa-paperclip"></i> Disclosure</th>
                                                <th style="text-align: center"><i class="fa fa-shield"></i> Contingency</th>
                                                <th style="text-align: center"><i class="fa fa-handshake-o"></i> COE</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td>132 Broadway<br>Los Gatos, CA 93940</td>
                                            ...
                                            <tr>
                                                <td>323 Broadway<br>Los Gatos, CA 93940</td>
                                                <td>Mali King<br>(408) 348-8336</td>
                                                <td>5/4/17</td>
                                                <td>5/6/17</td>
                                                <td>5/9/17</td>
