...
<html>
  ...
  <body class="hold-transition skin-red-light sidebar-mini">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="agent-active-properties.php">
                <i class="fa fa-home"></i>
                <span>My Active Properties</span>
              </a>
            </li>
            <li>
              ...
              <div class="box box-success">
                ...
                <div class="box-body">
                  ...
                  <ul id="incomplete-tasks">
                    <li><input type="checkbox">
                      <label>Pay Bills</label><input type="text">
                      <button class="edit">Edit</button>
                      <button class="delete">Delete</button>
                    </li>
                    <li class="editMode"><input type="checkbox">
                      <label>Go Shopping</label><input type="text" value="Go Shopping">
                      <button class="edit">Edit</button>
                      <button class="delete">Delete</button>
                    </li>
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>&copy; 2016 |
        <a href="#">Re/Max Salinas</a>.</strong>
      All rights reserved.
    </footer>
    ...
    <script>
      ...
      $(function () {
        $("#agent-table").DataTable({"paging": false});
      });
    ...
    <script>
      ...
      var taskIncomplete = function () {
        ...
        // When checkbox is unchecked Append the task list item #incomplete-tasks
        var listItem = this.parentNode;
        incompleteTasksHolder.appendChild(listItem);
        bindTaskEvents(listItem, taskCompleted);
      }
