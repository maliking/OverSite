...
$potentialGross = potentialAlgo($fyResult['TYGross'], ($potentialGross) * .02) - (350 * $activeListings);
...
$sqlTransactions = "SELECT *, ADDDATE(transactions.coeOrgDate,transactions.coeDays) AS coeDueDate FROM transactions WHERE (userId = :userId OR coAgentId = :userId OR agentId = :userId)AND junk != \"junk\" ORDER BY coeDueDate ASC";
