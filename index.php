                ...
                $.post( "getInContractNotes.php", { transId: transId })
                      .done(function( data ) {
                        ...
                        for(x in result)
                        {
                            ...
                            cell2.innerHTML = "<textarea class='form-control' rows='2' id='note" + result[x].noteId + "' style='resize:none; border: solid 1px black; width: 100%' onchange='saveInContractNote(this)'>" + result[x].note + "</textarea>";
