            ...
            if(note != "" && note != null)
            {
                $.post( "addNewInContractNote.php", { transId: transId, note:note })
                  .done(function( data ) {
                    ...
                    cell2.innerHTML = "<textarea class='form-control' rows='2' id='comment' style='resize:none; border: solid 1px black; width: 100%' onchange='saveInContractNote(this)'>" + note + "</textarea>";
                    alert( "Note Added");
                    $('#addNewNoteInContractArea').val("");
                  });
            }
